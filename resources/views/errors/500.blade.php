...
<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
	...
	<div class="d-flex flex-column flex-root" id="kt_app_root">
		...
		<style>
			body {
				background-image: url("{{ url(' /') }}/metronic/media/auth/bg7.jpg");
			}

			[data-theme="dark"] body {
				background-image: url("{{ url(' /') }}/metronic/media/auth/bg7-dark.jpg");
			}
		</style>
		<!--end::Page bg image-->
		<!--begin:: Message -->
			...
			<div class="d-flex flex-column flex-center text-center p-10">
				...
				<div class="card card-flush w-lg-650px py-5">
					<div class="card-body py-15 py-lg-20">
						<!--begin::Title-->
						<h1 class="fw-bolder fs-2qx text-gray-900 mb-4">Error del sistema</h1>
						<!--end::Title-->
						<!--begin::Text-->
						<div class="fw-semibold fs-6 text-gray-500 mb-7">¡Algo salió mal! Por favor, inténtelo de nuevo más tarde.</div>
						<!--end::Text-->
						<!--begin::Illustration-->
						<div class="mb-11">
							<img src="{{ url('/') }}/metronic/media/auth/500-error.png" class="mw-100 mh-300px theme-light-show" alt="" />
							<img src="{{ url('/') }}/metronic/media/auth/500-error-dark.png" class="mw-100 mh-300px theme-dark-show" alt="" />
						</div>
						<!--end::Illustration-->
						<!--begin::Link-->
						<div class="mb-0">
